...
<div class="admin-page-content space-y-6 min-w-0">
    ...
    <div class="bg-gradient-to-r from-primary-500 to-primary-700 rounded-2xl p-6 text-white shadow-3d-lg">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-primary-100">Manage the About Us page content</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-3d overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">About Us Content</h3>
        </div>
        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('admin.content.about-us.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
